...
import {
  SettingButton,
} from "../styles/theme/ThemeSwitching.styled";
...
export default function NavBar(): React.ReactElement {
  ...
  return (
    <header
      className={`${
        selectedTheme === "light" ? styles.light_header : styles.dark_header
      }`}
    >
      <div>
        <Link href="/">
          <Image
            className={`${
              selectedTheme === "light" ? styles.logo_light : styles.logo_dark
            }`}
            src="/physics.svg"
